  ...
  <body>
    ...
    ?>
      ...
      <section class="bg-light text-dark p-4 text-sm-start">
        ...
        method="post">
        <?php if($_REQUEST['status'] == "pass"){ ?>
          <h4><span class="text-success"> Password Changed Successfully</span></h4>
        <?php } ?>

        <?php if($_REQUEST['status'] == "fail"){ ?>
          <h4><span class="text-danger"> Current Password is incorrect</span></h4>
        <?php } ?>
