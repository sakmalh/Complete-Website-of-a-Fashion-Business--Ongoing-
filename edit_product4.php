          ...
          if($_REQUEST['status'] == "pass"){
            ...
            <div class="alert alert-secondary alert-dismissible fade show" role="alert">
              ...
              <hr>
                ...
                <a href="edit_product1.php" class="btn btn-success mt-2">Edit Another Product</a>
            </div>
            <?php
          }
          else{
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong>Failed</strong> Editing record failed. Try again
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              <hr>
              <hr>
                <a href="dashboard.php" class="btn btn-dark mt-2">Dashboard</a>
                <a href="edit_product1.php" class="btn btn-danger mt-2">Try Again</a>
            </div>
            <?php
          }
